...
%	document for Accessibility Performance Captions because typing the script 
%	in LaTeX is faster than centering text in PowerPoint in each slide. 
...
\usepackage[none]{hyphenat}					% Used to wrap words nicely
