...
% templateDescription: LaTeX template document for course notes at University.
...
\newcommand{\myTitle}{\myCourseCode \myCourseCredits: \myCourseTitle \\ 
	\myCourseSemester - \myCourseSchedule}
% =========================== Variables ===========================

% =========================== Shortcuts ===========================
\newcommand{\comment}[1]{}                          % Multiline comments
\newcommand{\image}[1]{[\textbf{IMAGE MISSING #1}]} % #1: descriptor for image
...
\pagenumbering{roman}   % Use roman numbers before the start of script 
